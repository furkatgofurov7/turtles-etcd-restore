...
func (in *EtcdBackupConfig) DeepCopyInto(out *EtcdBackupConfig) {
	*out = *in
	...
	if in.S3EtcdBackupConfig != nil {
		in, out := &in.S3EtcdBackupConfig, &out.S3EtcdBackupConfig
		*out = new(S3EtcdBackupConfig)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *S3EtcdBackupConfig) DeepCopyInto(out *S3EtcdBackupConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new S3EtcdBackupConfig.
func (in *S3EtcdBackupConfig) DeepCopy() *S3EtcdBackupConfig {
	if in == nil {
		return nil
	}
	out := new(S3EtcdBackupConfig)
